...
const imageRules = [
  {
    title: "محصولات",
    text: "استاندارد ثابت فروشگاه برای همه تصاویر محصول ۱۲۰۰ در ۱۵۰۰ پیکسل با نسبت عمودی ۴:۵ است. فرمت WebP پیشنهاد می‌شود (JPG نیز قابل قبول است). تصویر باید روشن، شارپ، بدون واترمارک و با پس‌زمینه ساده باشد.",
  },
  {
    title: "گالری محصول",
    text: "تمام تصاویر اصلی و واریانت‌ها را دقیقاً با اندازه ۱۲۰۰ × ۱۵۰۰ و نسبت ۴:۵ بارگذاری کنید. محصول را وسط کادر بگذارید و در بالا، پایین و کناره‌ها فضای امن باقی بگذارید؛ نور، فاصله دوربین و رنگ پس‌زمینه همه تصاویر نیز یکسان باشد.",
  },
  {
